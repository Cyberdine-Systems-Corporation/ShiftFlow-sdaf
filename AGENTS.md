...
|--------|----------|--------|
| Specification | [sdaf-core/agents/specification-agent.md](sdaf-core/agents/specification-agent.md) | active |
| Architecture | [sdaf-core/agents/architecture-agent.md](sdaf-core/agents/architecture-agent.md) | active |
| Testing+Review | [sdaf-core/agents/testing-review-agent.md](sdaf-core/agents/testing-review-agent.md) | active |
| Stubs Product/Domain/Application/DevOps/Review/Testing | `sdaf-core/agents/*` | stub |
...
- Core: `sdaf-core/skills/` (`sdaf-gate0`, `sdaf-bootstrap`, `sdaf-upgrade`, …)
- Pack: `skills/csharp-adr006-slice`, `blazor-bff-slice`, `aspire-local-run`
