...
| # | Evidencia |
|---|-----------|
| G0.1 | `specs/product/SPEC-PRD-001-mvp-capabilities.md` Draft (C-LOC). Sin spec de dominio nueva: no hay invariantes de negocio nuevas. |
| G0.2 | Criterios de esta PBI. |
| G0.3 | `architecture/decisions/ADR-007-ef-migrations.md` (Propuesto 2026-08-13). |
| G0.4 | Este archivo. |
| G0.5 | `worklogs/PBI-014-ef-migrations/` (crear al iniciar) |
