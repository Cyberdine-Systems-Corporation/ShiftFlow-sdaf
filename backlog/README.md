...
Gate 0: specs Approved + ADR-009 Aceptado antes de código.

| Orden | ID | Título | Oleada | Specs / ADR | Estado |
|------:|----|--------|--------|-------------|--------|
| 16 | [PBI-016](PBI-016-rule-catalog-ihardrule.md) | Catálogo IHardRule | Plataforma | DOM-008, APP-006, ACC-006, ADR-009 | Pendiente |
...
| 18 | [PBI-018](PBI-018-hr04-night-parity.md) | HR-04 Noches pares/impares | Oleada 1 | DOM-008 §4.2 | Pendiente |
| 19 | [PBI-019](PBI-019-hr05-monthly-hour-bag.md) | HR-05 Bolsa mensual | Oleada 1 | DOM-008 §4.2 | Pendiente |
| 20 | [PBI-020](PBI-020-hr06-max-consecutive-days.md) | HR-06 Racha máxima | Oleada 1 | DOM-008 §4.2 | Pendiente |
| 21 | [PBI-021](PBI-021-hr07-night-quotas.md) | HR-07 Cuotas nocturnas | Oleada 2 | DOM-008 §4.2 | Pendiente |
| 22 | [PBI-022](PBI-022-hr08-intermonth.md) | HR-08 Intermensual | Oleada 2 | DOM-008 §4.2 (bloqueado semántica) | Pendiente |
