...
| # | Evidencia |
|---|-----------|
| G0.1 | SPEC-APP-005 y SPEC-ACC-005 **Draft** (2026-08-14). SPEC-DOM-006 / ADR-003 / SPEC-PRD-001 Draft. |
| G0.2 | Criterios de esta PBI + SPEC-ACC-005 ACC-S3-X01…X07. |
| G0.3 | ADR-003 Propuesto (stub de explicación; no motor de escritura). Sin ADR nuevo. |
| G0.4 | Este archivo. |
| G0.5 | `worklogs/PBI-011-ai-explain-stub/` (crear al iniciar) |
