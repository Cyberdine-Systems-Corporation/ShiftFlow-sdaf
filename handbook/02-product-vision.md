...
|---------|--------|--------|
| 0.1.3-draft | 2026-09-18 | Horizonte: `post-mvp-rules-v2` incluye hard + soft |
| 0.1.2-draft | 2026-09-18 | Horizonte: primer corte hard-only `post-mvp-rules-v2` (superseded) |
