...
Esto es **IA de producto** (adaptador en Infrastructure), no un agente de ingeniería del repo (H06 §2). En el MVP el adaptador es un **stub determinista** (plantillas por código de regla). No se exige un LLM real.
