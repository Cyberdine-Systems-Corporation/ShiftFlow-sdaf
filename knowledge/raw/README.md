...
Según [`sdaf-core/handbook/03-repository-organization.md`](../../sdaf-core/handbook/03-repository-organization.md): esta carpeta es inmutable en intención. No se “corrige” al experto aquí; las interpretaciones van a `specs/` y las extracciones estructuradas a `knowledge/curated/`.
